...
if (cert.prismarineChunkPatch?.patchId !== 'hem-prismarine-chunk-1215-nosize-v2' || cert.prismarineChunkPatch?.reports?.length < 1) throw new Error('Certification requires the HEM 1.21.5 prismarine-chunk no-size-prefix decoder patch')
