...
This source tree is **HEM 1.0.0 RC17**, not a falsely labeled final build.
...
Local source verification currently passes **85/85 tests** and **53/53 release contracts**. The final release gate is `.github/workflows/system-1215.yml`, which must successfully:
