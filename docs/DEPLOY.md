...
Run **HEM 1.21.5 System Acceptance** in GitHub Actions. It defaults to the exact pinned upstream v0.1.99 stable commit with inherited 1.21.5 protocol provenance `0359f20b8d721ea44c7ddb633c985a71574c73d3` and rejects moving branch/tag refs. To test another upstream revision, provide another exact 40-character SHA. It should upload rendered browser evidence plus `hem-1215-certification.json` and end with:
