...
6. Both clients load protocol 770 / 1.21.5 registries and live rendered chunk-section meshes; `hem-build.json` must attest the deterministic `hem-prismarine-chunk-1215-nosize-v4` block/biome no-size-prefix decoder patch before the renderer gate can pass.
